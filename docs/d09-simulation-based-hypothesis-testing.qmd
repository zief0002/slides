...
filters:
  - roughnotation
# Need to install the roughnotation filter 
# In Terminal: quarto install extension EmilHvitfeldt/quarto-roughnotation  
---
...
- <span style="color:#FF2F92;">Describe a simulation approach to hypothesis testing</span>
...
- **Goal:** Get an estimate for the sampling variability expected given this sample
  + [Simulation (resampling methods)]{.rn rn-type=highlight}
...
- <span style="color:#FF2F92;">Simulation is one method to conduct a hypothesis test (it helps us estimate sampling variability and visualize the null hypothesized model).</span>
